...
list_domains_response = identity_client.list_domains(
    ...
    url="https://idcs-6a3173363e9c4ffaa15c184b3a9ee911.identity.oraclecloud.com:443",
    # home_region_url="EXAMPLE-homeRegionUrl-Value",
    # type="EXAMPLE-type-Value",
    # license_type="EXAMPLE-licenseType-Value",
    ...
    # sort_by="NAME",
    # sort_order="ASC",
    # opc_request_id="0BGIEPJPV0TXQOSDCWE1<unique_ID>",
    # lifecycle_state="ACTIVE"
    )

# Get the data from response
print(list_domains_response.data)